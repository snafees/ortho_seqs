...
class rf1d:
    ...
    def density(
        ...
        if border:
            ...
            width = 0
        sns.distplot(x_red, hist=True, kde=True, color="blueviolet", hist_kws={'edgecolor':'black'}, kde_kws={'linewidth': 3.2})
        plt.ylabel(self.phenotype + " regressions")
        if out_dir is not None:
    ...
    def heatmap(self, out_dir=None):
        ...
        ax.set_ylabel(str(self.phenotype, "Values"))
        fig.tight_layout()
    ...
    def boxplot(self, out_dir=None):
        ...
        ylab = str(self.phenotype) + " regressions"
